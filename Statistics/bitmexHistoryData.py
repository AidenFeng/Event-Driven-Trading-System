...
class bitmexHistoryBarData(object):
    ...
    def _to_timestamp(year, month, day, hour=0, minute=0, second=0, millsecocnd=0):
        """
        NOT USED
        convet to timestamp string, eg. '2022-03-25T08:00:00.000Z'
        """
...
class bitmexHistoryTickData(object):
    ...
    def __init__(self, symbol, startTime, endTime):
        ...
        self.startTime = startTime   # '2022-03-10 20:00:00'
        self.endTime = endTime    # '2022-03-10 20:10:00'
    ...
    def _check_start_end(start_time, end_time):
        ...
        try:
            ...
            raise ValueError('Can not format start_time or end_time.' +
                             'Must be string of formmat "2022-03-10 20:10:00"\n' +
                             'Error: %s' % e)
...
if __name__ == '__main__':
    if True:
        ...
        symbol = 'XBTUSD'
        startTime = '2022-03-07 20:00:00'
        endTime = '2022-03-07 20:05:00'
